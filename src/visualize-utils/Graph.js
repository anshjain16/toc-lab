...
export default class Graph {
    ...
    // data - is of the form : {numNodes, nodes, edges} 
    // numNodes = number of nodes/vertices in the graph
    // nodes => [ {id : 'uniqueid'} ]
    // edges => [ ['uid', 'vid'] ]  2 - D list,  edge between Node having uid - Node having vid
    // currently in this we do not check for self loop/edge, so do net send a data that may contain self edge
    // it may result in error in layout, will be raised as a issue further and handled afterwards 
    constructor(data) {
